...
# 1 "classroomA.h" 1
# 22 "classroomA.h"
extern const unsigned short classroomATiles[752];


extern const unsigned short classroomAMap[1024];


extern const unsigned short classroomAPal[256];
# 146 "main.c" 2
# 1 "collisionMap.h" 1
# 21 "collisionMap.h"
...
void goToStart() {
    ...
    DMANow(3, startScreenTiles, &((charblock *)0x6000000)[0], 3008 / 2);
...
void goToInstructions() {
    ...
    DMANow(3, instructionsScreenTiles, &((charblock *)0x6000000)[0], 4672 / 2);
...
void goToGame() {
    ...
    DMANow(3, mainMapPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, mainMapTiles, &((charblock *)0x6000000)[0], 1056 / 2);
    DMANow(3, mainMapMap, &((screenblock *)0x6000000)[31], 2048 / 2);
    ...
    if (prevMap != currMap) {
        ...
        switch (currMap) {
            case MAIN:
                ...
                break;
            case CLASSROOMA:
                DMANow(3, classroomAPal, ((unsigned short *)0x5000000), 256);
                DMANow(3, classroomATiles, &((charblock *)0x6000000)[0], 1504 / 2);
                DMANow(3, classroomAMap, &((screenblock *)0x6000000)[31], 2048 / 2);
                break;
            case STORAGEROOM:
                DMANow(3, storageRoomPal, ((unsigned short *)0x5000000), 256);
                DMANow(3, storageRoomTiles, &((charblock *)0x6000000)[0], 352 / 2);
                DMANow(3, storageRoomMap, &((screenblock *)0x6000000)[31], 2048 / 2);
                break;
            case RESTROOM:
...
void goToWin() {
    ...
    DMANow(3, winScreenTiles, &((charblock *)0x6000000)[0], 2208 / 2);
...
void goToLose() {
    ...
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 2080 / 2);
